 ...
 */
   ...
   *  </code>
   */
  class Google_ChannelsServiceResourceYT extends Google_ServiceResource {
     ...
     */
    public function update($part, Google_ChannelYT $postBody, $optParams = array()) {
      $params = array('part' => $part, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
        return new Google_ChannelYT($data);
      } else {
        return $data;
      }
    }
...
class Google_ChannelYT extends Google_Model {
...
class Google_ChannelListResponse extends Google_Model {
  public $etag;
  public $eventId;
  protected $__itemsType = 'Google_ChannelYT';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $nextPageToken;
  ...
  public function setItems(/* array(Google_Channel) */ $items) {
    $this->assertIsArray($items, 'Google_ChannelYT', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
